...
def createRankedGradesTable(table_name, host, user, password, port, charset, database):
    ...
    #     table_name)
    sql = (
        f'create table {table_name} (姓名 varchar(20) not null, 学号 varchar(20) not null, 语文 varchar(20) not null,'
...
def createUsersTable(table_name, host, user, password, port, charset, database):
    ...
    sql = (
        f'create table {table_name} (用户名 varchar(20) not null, 密码 varchar(20) not null, 学号或工号 varchar(20) not null,'
        f' 类型 varchar(20) not null);')
...
def createCheckApplicationsTable(table_name, host, user, password, port, charset, database):
    ...
    sql = (
        f'create table {table_name} (申请老师 varchar(20) not null, 被申请学生姓名 varchar(20) not null, 学生学号 varchar(20) not null'

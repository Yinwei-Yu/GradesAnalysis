...
# 3. 查找个人成绩
# 4. 个人成绩分析
def disp_grades(tea_window):
    tea_window.withdraw()
    grade_window = tk.Toplevel(tea_window)
    grade_window.title("查看成绩")
    disp_all_grades_button = tk.Button(grade_window,text='显示所有学生成绩',command=disp_all_grades,width=30,height=3)
    disp_all_grades_button.pack(pady=10)
    disp_all_analysis_button = tk.Button(grade_window,text='总体成绩分析',command=disp_all_analysis,width=30,height=3)
    disp_all_analysis_button.pack(pady=10)
    disp_single_grade_button = tk.Button(grade_window,text='查看个人成绩',command=disp_single_grade,width=30,height=3)
    disp_single_grade_button.pack(pady=10)
    disp_single_analysis_button = tk.Button(grade_window,text='查看个人成绩分析',command=disp_single_analysis,width=30,height=3)

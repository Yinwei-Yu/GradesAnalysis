...
l=tk.Label(Login_window,text='高考成绩管理系统',font=('Arial',20),width=20,height=2)
l.pack(side='top')
...
radiobt_student=tk.Radiobutton(Login_window,text='学生',variable=identity_var,value='学生',command=identity_selection)
radiobt_teacher=tk.Radiobutton(Login_window,text='老师',variable=identity_var,value='老师',command=identity_selection)
radiobt_administrator=tk.Radiobutton(Login_window,text='管理员',variable=identity_var,value='管理员',command=identity_selection)
...
bt_logout=tk.Button(Login_window,text='退出',font=('Arial',12),width=10,height=1)
